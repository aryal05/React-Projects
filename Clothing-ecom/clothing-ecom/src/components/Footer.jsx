                                             ...
                                             <ul className='lab-ul social-icons'>
                                                  {
                                                       socialList.map((val,i)=>(
                                                            <li key={i}>
                                                               ...
                                                               <a href="#" className={val.className}><i className={val.iconName}
                                                               >{val.text}</i></a>
                                                            </li>
                                                       ))
                                                  }
...
<div className="footer-bottom">
     <div className="container">
          <div className="section-wrapper">
               <p>&copy; 2024 <Link to="/">Shop cart</Link> Designed by  <a href="/" target='_blank'>Rajat</a></p>
               <div className='footer-bottom-lsit'>
                    {
