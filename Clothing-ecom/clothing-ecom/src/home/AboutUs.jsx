...
const desc = "Take courses on your any devices with our app & learn all about business waht you want.Just download & install & start to learn."
               ...
               <div className="row g-4 justify-content-center align-item-center row-cols-1 row-cols-md-2 row-cols-xl-3">
                    ...
                    <div className='col'>
                         <div className='instructor-content'>
                              <span> className='subtitle'</span>{subTitle}
                              <h2 className='title'>
                                   {title}
                              </h2>
                              <p>{desc}</p>
                    ...
                    <div className="col">
                         <div className="instructor-thumb">
                              <img src="/src/assets/images/instructor/home.jpg" alt="" />
                         </div>
                    </div>
               </div>
          </div>
